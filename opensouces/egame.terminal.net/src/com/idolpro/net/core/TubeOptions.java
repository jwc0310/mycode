...
public class TubeOptions {
    ...
    protected String deleteUrlParam=null;
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setPostEntity(List<? extends NameValuePair> parameters, String charset) {
            try {
        	if(this.mHttpMethod!=HTTP_METHOD_DELETE)
                this.mPostEntity = new UrlEncodedFormEntity(parameters, charset);
        	else 
		this.deleteUrlParam=URLEncodedUtils.format(parameters, charset);    
        ...
        public TubeOptions create() {
            ...
            option.deleteUrlParam=this.deleteUrlParam;
