 ...
 */
package com.idolpro.net;

import java.util.LinkedList;

import com.idolpro.net.core.EgameTube;
import com.idolpro.net.core.TubeConfig;
import com.idolpro.net.core.TubeOptions;
import com.idolpro.net.core.HttpConnector.EntityResult;
...
import com.idolpro.net.listener.TubeListener;
...
public class FastTube {
    ...
    private volatile static FastTube instance;
     ...
     * @param opt
     * @return 封装后包含流的对象
     * @see com.idolpro.net.core.HttpConnector.EntityResult
     */
