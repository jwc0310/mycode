...
public class Danmu extends Activity implements View.OnClickListener {
...
//        mBtnSendDanmakuTextAndImage = (Button) findViewById(R.id.btn_send_image_text);
        findViewById(R.id.btn_send_image_text).setOnClickListener(this);
...
//                    Log.d("DFM", "danmakuShown(): text=" + danmaku.text);
        ...
        if (mVideoView != null) {
            ...
            mVideoView.setVideoPath(Environment.getExternalStorageDirectory() + "/Movies/Touch_The_Sky.mp4");
        }
    ...
    public void onClick(View v) {
        ...
        if (v == mBtnRotate) {
            ...
            addDanmaku(false);
        } else if (v.getId() == R.id.btn_send_image_text) {
    ...
    private SpannableStringBuilder createSpannable(Drawable drawable) {
        ...
        spannableStringBuilder.setSpan(new BackgroundColorSpan(Color.parseColor("#8A2233B1")), spannableStringBuilder.length()-1, spannableStringBuilder.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
